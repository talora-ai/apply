...
{
    public function resumes(): HasMany { return $this->hasMany(UserResume::class); }
    public function resumeAnalyses(): HasMany { return $this->hasMany(ResumeAnalysis::class); }
    ...
    public function jobFavorites(): HasMany { return $this->hasMany(JobFavorite::class); }
